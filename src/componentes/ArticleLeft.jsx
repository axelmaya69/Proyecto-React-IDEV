...
function ArticleLeft({ title, image, parrafoUno, parrafoDos }) {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 xl:gap-12 mb-20 my-10 mt-10 sm:mt-20 sm:my-20 mx-2 sm:mx-10 md:mx-20 lg:my-20 lg:py-20">
      ...
      <div className="col-span-1  lg:row-start-1 lg:col-span-1 lg:col-start-1">
