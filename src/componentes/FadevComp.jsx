...
function FadevComp({imagen,titulo,p1,p2,p3,p4}) {
  return (
    <Fade >
    <div className='grid grid-cols-1 sm:grid-cols-3 sm:grid-rows-5 sm:mt-24  mx-2 '>
      ...
      <p className='sm:col-span-2 sm:row-span-1 order-3 my-2 lg:text-xl'>{p1}</p>
      <p className='sm:col-span-2 sm:row-span-1 order-4 my-2 lg:text-xl'>{p2}</p>
      <p className='sm:col-start-2 sm:col-span-2 sm:row-span-1 order-5 my-2 lg:text-xl'>{p3}</p>
      <p className='sm:col-start-2 sm:col-span-2 sm:row-span-1 order-6 my-2 lg:text-xl'>{p4}</p>
