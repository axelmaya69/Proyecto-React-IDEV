...
return (
    ...
    <div className='grid grid-cols-1 m-4 lg:grid-cols-2 gap-2 lg:gap-10 my-20 z-50'>
        ...
        {images.map((image, index) => (
            ...
            src={image}
            alt={`Image ${index + 1}`}
                className=' lg:rounded lg:hover:scale-110 transition-all duration-300 lg:cursor-pointer z-50'
        />
            </div>
        ))}
        </Fade>
    ...
    {selectedImage && (
        <div className=' hidden lg:block lg:fixed lg:top-0 lg:left-0 lg:right-0 lg:bottom-0 lg:flex lg:justify-center lg:items-center lg:bg-black lg:bg-opacity-75'>
