...
function Alumnos() {
  ...
  return (
    <div>
        ...
        <div className="absolute bottom-0 left-0 right-0 top-0 h-full w-full overflow-hidden bg-fixed bg-black bg-opacity-60">
          <div className="h-full " >
            <div className="my-40 lg:my-32">
              <div>
            <Slide direction='up'>
              <h2 className="text-6xl sm:text-7xl my:10 mx-4 lg:text-9xl text-white font-bold">Alumnos</h2> 
              </Slide>
              </div> 
      ...
      <div className='grid grid-cols-1 lg:grid-cols-4 my-4  lg:mx-10 mx-2 lg:relative lg:gap-10'>
  ...
  <div className='flex flex-wrap justify-center items-center lg:w-full sm:my-10 '>
    <div className='lg:w-full'>
      <button className='bg-teal-300 font-semibold lg:hover:scale-110  transition duration-150  px-3 py-2 rounded lg:rounded-none my-4 lg:my-0 text-white shadow-lg  w-full border-b border-white' onClick={() => window.location.href = '#titulouno'}>Titulo 1</button>
      <button className='bg-violet-700 font-semibold lg:hover:scale-110  transition duration-150  px-3 py-2 rounded lg:rounded-none text-white shadow-2xl w-full border-b border-white ' onClick={() => window.location.href = '#titulodos'}>Titulo 2</button>
    </div>
  </div>
</div>

        <div className=' mx-2 lg:col-start-2 lg:col-span-3 lg:row-start-1'>
      <h1 className='font-bold text-xl my-4' id='titulouno'>Titulo 1</h1>
      ...
      <h2 className='font-bold text-xl my-4' id='titulodos'>Titulo 2/Subtitulo</h2>
