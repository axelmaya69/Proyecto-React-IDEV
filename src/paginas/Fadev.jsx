...
function Fadev() {
  ...
  <img className="m-auto " src="https://www.procine.cdmx.gob.mx/storage/app/uploads/public/644/fe2/954/644fe2954deea427920675.jpg" alt="animacion imagen" />
        ...
        <div className=' col-span-4 lg:col-span-3 lg:col-start-2 '>
          ...
          <div className='bg-orange-400 my-10 shadow-2xl m-5 flex items-center justify-center flex-col hover:scale-110 transition-all duration-400 rounded w-4/5 h-4/5 cursor-pointer border sm:border-2 border-black p-2 sm:p-4 lg:border-none' onClick={() => window.location.href = '/2020'} ><span className='my-3'>FADEV 2020</span>
          ...
          <div className='bg-blue-400 my-10 drop-shadow-2xl mx-5 flex items-center justify-center flex-col hover:scale-110 transition-all duration-400 rounded w-4/5 h-4/5 cursor-pointer border sm:border-2 border-black p-2 sm:p-4 lg:border-none'  onClick={() => window.location.href = '/2021'}  ><span className='my-3'>FADEV 2021</span>
          ...
          <div className='bg-violet-400 my-10 shadow-2xl mx-5 flex items-center justify-center flex-col hover:scale-110 transition-all duration-400 rounded w-4/5 h-4/5 cursor-pointer border sm:border-2 border-black p-2 sm:p-4 lg:border-none'  onClick={() => window.location.href = '/2022'} > <span className='my-3'>FADEV 2022 </span>
          <img src="https://iadevtesjo.files.wordpress.com/2022/06/propuesta_logo_grises.png?w=153" alt="fadev-2022" />
          </div>
          <div className='bg-red-400 my-10 shadow-2xl mx-5 flex items-center justify-center flex-col hover:scale-110 transition-all duration-400 rounded w-4/5 h-4/5 cursor-pointer border sm:border-2 border-black p-2 sm:p-4 lg:border-none' onClick={() => window.location.href = '/2023'} ><span className='my-3'>FADEV 2023</span>
          <img src="https://esfadev.com/wp-content/uploads/2023/06/PortadaFB-1024x576.png" alt="fadev-2023" />
          </div>
          <div className='bg-yellow-400 shadow-2xl my-10 mx-2 flex items-center justify-center flex-col hover:scale-110 transition-all duration-400 rounded w-4/5 h-4/5 cursor-pointer border sm:border-2 border-black p-2 sm:p-4 lg:border-none' onClick={() => alert("En Planeación... \n  ;)") } ><span className='my-3'>#RoadToFADEV-2024</span>
