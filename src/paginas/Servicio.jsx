  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 mx-2 my-5 lg:relative ">
        ...
        {/* <div className="col-span-1 lg:col-start-1 border-blue-500 lg:sticky lg:top-0 lg:left-0 lg:bottom-0 lg:max-h-screen lg:mb-56 bg-white border sm:border-2 rounded p-2 sm:p-4 shadow-2xl">


          <p className="px-2">
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Sint ut
            quod iste vero, placeat consequatur aut aspernatur alias
            voluptatibus earum quas ipsum magni, quisquam numquam quis tempora
            ab dicta labore!
          </p>
        </div> */}
